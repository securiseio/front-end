  ...
  return new Promise(function(resolve) {
    resolve({
      ...
      agencyLanding: {
        ...
        header_dark: 'gelap',
        header_light: 'terang',
        banner_title: 'Buat Solusi Bisnis',
        banner_subtitle:
          'Kami bekerja dengan startup internasional, membantu wirausahawan meluncurkan untuk jangka panjang.',
        banner_button: 'menulis kepada kami',
        about_title: 'Tentang kami',
        about_subtitle:
          'Melalui kapasitas besar kami, kami berani mengatakan bahwa kami berbeda.',
        about_employee: 'karyawan',
        about_projects: 'proyek',
        about_client: 'klien',
        about_quote: 'Meninggalkan rasa yang pahit. Itu disebut blues',
        ...
        expertise_paragraph:
          'Itulah sebabnya kami memberi Anda sumber daya manusia yang Anda butuhkan untuk membangun kapan pun Anda membutuhkannya. Tim kami yang berada di dekat & dekat kantor kami dilatih dan diawasi sebagai bagian dari Kami. Tim Anda didedikasikan untuk proyek Anda. Dan tim fleksibel! ',
