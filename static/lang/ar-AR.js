  ...
  return new Promise(function(resolve) {
    resolve({
      ...
      agencyLanding: {
        ...
        'header_our-expertise': 'خبرتنا',
        header_testimonials: 'شهادات',
        'header_case-studies': 'دراسات الحالة',
        header_our_office: 'مكتبنا',
        header_contact: 'اتصل',
        header_language: 'لغة',
        header_theme: 'وضع السمة',
        header_dark: 'داكن',
        header_light: 'ضوء',
        banner_title: 'إنشاء حلول أعمال',
        banner_subtitle:
          'نحن نعمل مع شركات ناشئة دولية ، وسنساعد رواد الأعمال على الإطلاق على المدى الطويل.',
        banner_button: 'اكتب لنا',
        about_title: 'عنا',
        about_subtitle: 'من خلال قدرتنا الكبيرة ، نجرؤ على القول إننا مختلفون.',
        about_employee: 'موظف',
        about_projects: 'مشاريع',
        about_client: 'عملاء',
        about_quote: 'إنه يترك مذاقًا حلوًا ومرًا يسمى',
        services_title: 'خدماتنا',
        services_button: 'راجع التفاصيل',
        expertise_title: 'خبرتنا',
        expertise_subtitle: 'تم بناء مشروع ناجح مع فريق ناجح.',
        expertise_paragraph:
        ...
        testimonial_title: 'شهادة العميل',
        case_title: 'دراسات الحالة',
        cta_title: 'هل أنت جاهز للبدء؟',
        cta_subtitle: 'فريق Best Tech لا يولد فورًا ، إنه مصنوع ...',
        cta_btn: 'اتصل بنا',
        office_title: 'مكتبنا',
        office_head: 'المركز الرئيسى',
        office_branch: 'مكتب فرعي',
        footer_paragraph:
          'لقد عملنا منذ ما يقرب من عقد من الزمان. مساعدتك هي أهم أولوياتنا.'
      }
    })
  })
}
